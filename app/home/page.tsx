    ...
    <section className="py-16 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="space-y-8">
            ...
            <div className="bg-white shadow-xl rounded-2xl p-6 border border-gray-100">
              ...
              <div className="mb-6 rounded-xl overflow-hidden shadow-md border border-gray-200">
                <div className="h-96 w-full">
                  <iframe
                    src={`https://www.youtube.com/embed/${results.youtubeReview.video_id}`}
              ...
              <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                <div className="mb-3 md:mb-0">
                  <h4 className="text-lg font-semibold text-gray-800">
                    {results.youtubeReview.channel_title}
                  </h4>
                  <p className="text-sm text-gray-600">
                    {results.youtubeReview.video_title}
                  </p>
                </div>
                <a
                  href={`https://www.youtube.com/watch?v=${results.youtubeReview.video_id}`}
                  target="_blank"
                  rel="noopener noreferrer"
          ...
          {/* Gemini Summary */}
          {expandedSections.gemini && results.geminiSummary && (
            <div className="bg-white shadow-xl rounded-2xl p-8 border border-gray-100">
