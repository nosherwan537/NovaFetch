  ...
  return (
    <AuroraBackground>
      ...
      >
        ...
        {/* Hero Section */}
        <main className="h-[55vh] flex flex-col justify-center items-center text-center px-4 z-50">
          <h2 className="text-5xl font-extrabold mb-4 leading-tight text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600 dark:from-cyan-400 dark:to-purple-500 z-60">
            Supercharge Your Search
          </h2>
          <p className="y-5  mb-6 max-w-xl mx-auto text-lg">
        ...
        {/* Features */}
        <section className="h-[35vh] bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800 px-4 flex items-center">
